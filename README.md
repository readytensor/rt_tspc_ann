# ANN Time Step Classifier in Torch

ANN Time Step Classification Model in Torch as per Ready Tensor specifications.
...
- A **ANN Time Step Classification** model built using **Torch**
