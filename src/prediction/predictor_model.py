...
class TimeStepClassifier:
    """ANN TimeStepClassifier.

    This class provides a consistent interface that can be used with other
    TimeStepClassifier models.
    """

    MODEL_NAME = "ANN_TimeStepClassifier"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new ANN TimeStepClassifier.
    ...
    def build_NNet_model(self) -> Net:
        """Build a new ANN TimeStepClassifier."""
        model = Net(
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the ANN TimeStepClassifier to disk.
    ...
    def load(cls, model_dir_path: str) -> "TimeStepClassifier":
        """Load the ANN TimeStepClassifier from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TimeStepClassifier: A new instance of the loaded ANN TimeStepClassifier.
        """
